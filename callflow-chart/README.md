...
| `startDate`     | `string` (ISO 8601 format, YYYY-MM-DD) | `null`                  | No       | Start date for filtering data. If a startDate and endDate are not provided, the component will set endDate to the date of the most recent call and startDate will be set to endDate - 7 days.    |
| `endDate`       | `string` (ISO 8601 format, YYYY-MM-DD) | `null`                  | No       | End date for filtering call data. If a startDate and endDate are not provided, the component will set endDate to the date of the most recent call and startDate will be set to endDate - 7 days. |
